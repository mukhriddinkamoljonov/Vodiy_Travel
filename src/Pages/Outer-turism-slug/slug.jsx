        ...
        <div className="grid lg:grid-cols-3 grid-cols-1 md:grid-cols-3 lg:gap-7 md:gap-7 gap-0 py-[50px]">
          <div className="col-span-2">
            <div className="flex justify-between items-center mb-8">
              ...
              <div>
                <div className="bg-green text-center flex items-center justify-center flex-col rounded-xl text-white w-[130px] h-[130px]">
            ...
            <div className="bg-green grid grid-cols-2 col-span-1 text-white p-4 mt-8 rounded-xl">
          ...
          <div className="col-span-1">
            <form className="bg-green p-5 text-white rounded-xl flex flex-col justify-center items-center text-center">
              ...
              <input
                required
                className="text-black px-4 mt-4 py-3 outline-none rounded-xl mb-4"
                type="text"
                name=""
              ...
              <input
                required
                className="text-black px-4 py-3 outline-none rounded-xl mb-4"
                type="number"
                name=""
              ...
              <textarea
                required
                className="w-[239px] h-[100px] outline-none rounded-xl py-2 px-4 text-black"
                placeholder="enter your message"
              />
              <button className="mt-8 border-white border px-4 py-2 rounded-xl">
                Habar yuborish
              </button>
            </form>
            ...
            <iframe
              className="w-full md:h-[150px] h-[150px] md:rounded-xl rounded-lg border-none mt-[30px]"
