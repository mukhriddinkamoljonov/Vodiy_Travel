...
const PackageCard = (props) => {
	...
	return (
		<div
			className="max-h-[520px] rounded-xl py-6 pl-6 pr-9 w-full"
			style={{
		...
		>
			...
			<div className="bg-white p-6 rounded-xl mt-[100px] opacity-70 max-w-[345px]">
				...
				<button
					...
					className="uppercase bg-green text-white py-2 px-4 mt-3 text-base rounded-xl flex items-center justify-center"
				>
					BUYURTMA BERISH
				</button>
			</div>
